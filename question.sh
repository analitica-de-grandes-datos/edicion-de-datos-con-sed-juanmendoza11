...
#
sed 's/,/./g' data.csv | sed 's/;/,/g' | sed 's/,$/\\N/g' | sed 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g' | sed 's/\([0-9]\)\//0\1\//g' | sed 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9][0-9][0-9]\)/\3-\2-\1/g' | sed 's/[a-z]/\U&/g'